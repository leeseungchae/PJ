...
class Exam(QWidget, form_window):
    def __init__(self):
        ...
        self.path = None
        self.setupUi(self)
        self.model = load_model('./output/news_category_classfication_model_0.4069400727748871.h5')
    ...
    def predict_genre(self):
        ...
        model = load_model('./output/news_category_classfication_model_0.4069400727748871.h5')
